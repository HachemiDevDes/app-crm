    ...
    <>
      ...
      <div className="drawer">
        <div className="drawer-header">
          <h3 style={{ fontSize: 16, fontWeight: 700 }}>Contact Details</h3>
          <button className="modal-close" onClick={onClose}><X size={16} /></button>
        </div>
          ...
          <div style={{ marginBottom: 24, display: 'flex', alignItems: 'center', gap: 16 }}>
            ...
            <div>
              ...
              <div style={{ marginTop: 8, display: 'flex', gap: 6 }}>
                {contact.is_new && <span className="badge badge-new">New</span>}
    ...
    <>
      ...
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">{contacts.length} total contact{contacts.length !== 1 ? 's' : ''}</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="table-empty">
            ...
            <div className="table-empty-title">
              {search || sourceFilter !== 'all' ? 'No contacts match your filters' : 'No contacts yet'}
            </div>
            <div className="table-empty-text">
              {search || sourceFilter !== 'all'
                ? 'Try adjusting your search or filters'
                : 'Add contacts manually or connect with people at events'}
            </div>
          </div>
        ) : (
                    ...
                    <div className="contact-cell">
                      ...
                      <div>
                        <div className="contact-name">
                          {c.name}
                          {c.is_new && <span className="badge badge-new" style={{ marginLeft: 8 }}>New</span>}
                        </div>
      ...
      {/* Add Modal */}
      {showAddModal && (
        <AddContactModal onClose={() => setShowAddModal(false)} onSave={loadContacts} />
      )}
